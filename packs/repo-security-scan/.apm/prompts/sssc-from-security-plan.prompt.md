...
* Create the project directory at `.sss/sssc-plans/{project-slug}/` and write `state.json` with `entryMode: "from-security-plan"`, `currentPhase: 1`, and `securityPlannerLink` set to the path of the source security plan.
