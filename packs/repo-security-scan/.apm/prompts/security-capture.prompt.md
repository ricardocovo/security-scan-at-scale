...
* Initialize capture mode by creating the project directory at `.sss/{project-slug}/plan/` and writing `state.json` with `entryMode: "capture"`, `currentPhase: 1`, and empty or default values for remaining fields.
